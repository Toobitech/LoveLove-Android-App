              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    vertical(10),
                    MyText(firstText: "1. Real Identity:", lastText:"By creating an account on Love Love, I confirm that all personal information I provide is accurate and truthful. I understand that using a fake identity or impersonating someone else is strictly prohibited."),

                    MyText(firstText: "2. Respectful Conduct:", lastText:"I agree to treat all users with respect and will not engage in harassment, bullying, hate speech, or any other form of harmful or disruptive behavior."),

                    MyText(firstText: "3.Reporting Violations:", lastText:"If I come across a profile or user engaging in harassment, bullying, hate speech, or any other disruptive behaviors, I will promptly report them. I acknowledge that Love Love is not legally responsible for the actions of its users."),

                    MyText(firstText: "4. Account Deactivation:", lastText:"If I violate these rules or engage in any behavior that goes against Love Love’s guidelines, I understand that Love Love reserves the right to deactivate my account without notice."),


                    MyText(firstText: "5.	Acceptance", lastText:"By signing up for Love Love, I acknowledge and agree to abide by these terms and any future updates."),
